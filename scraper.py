...
BASE_URL = "https://docs.oracle.com/en/cloud/saas/financials/26a/oedmf/apinvoicesall-26171.html"
...
def scrape_oracle_docs():
    ...
    for i, item in enumerate(links):
        ...
        try:
            ...
            # Find the table that looks like a column definition
            for t in tables:
            ...
            # Fallback to first table if no clear header match
    ...
    with open('oracle_financials_26a.json', 'w') as f:
        json.dump(data, f, indent=2)
        
    print(f"Scraping complete. Saved {len(data)} entries to oracle_financials_26a.json")
