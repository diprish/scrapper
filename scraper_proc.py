...
BASE_URL = "https://docs.oracle.com/en/cloud/saas/procurement/26a/oedmp/"
TOC_URL = "https://docs.oracle.com/en/cloud/saas/procurement/26a/oedmp/toc.htm"
...
def scrape_oracle_docs():
    ...
    for i, url in enumerate(links_to_visit):
        ...
        if columns:
            ...
            try:
                with open('oracle_data_proc.json', 'w') as f:
